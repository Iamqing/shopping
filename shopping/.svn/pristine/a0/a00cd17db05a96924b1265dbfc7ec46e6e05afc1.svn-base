	    ...
	    <tr>
	      <td><table width="150" border="0" cellspacing="0" cellpadding="0">
	        <tr>
	          ...
	          <td><a href="./myorder.jsp">已买到的宝贝</a></td>
            </tr>
	        <tr>
	          <td height="30" align="center"><img src="../images/li_style.png" width="4" height="4" alt="" /></td>
	          <td><a href="./manageraddress.jsp">我的收货地址</a></td>
            </tr>
            <tr>
	          <td height="30" align="center"><img src="../images/li_style.png" width="4" height="4" alt="" /></td>
	          <td><a href="./bankcard.jsp">我的银行卡</a></td>
            </tr>
	        <tr>
	          <td height="30" align="center"><img src="../images/li_style.png" width="4" height="4" alt="" /></td>
	        ...
	        <tr>
	          <td height="30" align="center"><img src="../images/li_style.png" width="4" height="4" alt="" /></td>
	          <td><a href="./personal.jsp">个人信息</a></td>
            </tr>
	        <tr>
	          <td height="30" align="center"><img src="../images/li_style.png" width="4" height="4" alt="" /></td>
...
<div id="main_right">
  ...
  <table cellspacing="0" cellpadding="0" style="width:800px; height:32px; border:1px solid #C4D5E0; background-color:#F9FAFC;">
  	  <tr>
  	    <td class="font12pxblackStrong">&nbsp;&nbsp;&nbsp;&nbsp;个人信息</td>
      </tr>
  </table>
  <!--搜索-->
  <table width="800" border="0" cellspacing="0" cellpadding="0">
    <form action="${pageContext.request.contextPath }/addInfo.action" method="get">
      <tr>
        <td height="40"><table width="800" cellspacing="0" cellpadding="0" style=" border:1px solid #CCC; border-top:none; display:block; margin-bottom:20px;">
          ...
          <tr>
            ...
            <td><input name="age" type="text" id="textfield3" size="40" /></td>
          </tr>
          <tr>
            <td height="30" align="right">单位：</td>
            <td><input name="unit" type="text" id="textfield4" size="40" /></td>
            </tr>
          <tr>
            <td height="30" align="right">职业：</td>
            <td><input name="profession" type="text" id="textfield5" size="40" /></td>
          </tr>
          <tr>
            <td height="30">&nbsp;</td>
